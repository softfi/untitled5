...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    print(
        "this is the firebase details that is being used for realtime chatting   sender.uid! ${sender.uid!}  receiverId ${widget.userData!.uid.validate()}");
    super.initState();
    //init();
  }
  ...
  sendMessage({FilePickerResult? result}) async {
    ...
    print("this is the player id ${widget.userData!.playerId}");
    notificationService
