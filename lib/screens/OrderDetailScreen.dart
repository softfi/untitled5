...
import 'package:untitled5/screens/reviewAtEndScreen.dart';
...
class OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  void test() async {
    await getCurrentRideRequest().then((value) async {
      appStore.setLoading(false);
      currentData = value;
      print(currentData?.status ?? "" + "thosd sdfsdf,ndsf dsf sdfjdsklff");
      mqttForUser();
      await orderDetailApi();
      setState(() {});
    }).catchError((error) {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                '${language.lblDistance} ${riderModel!.distance.toString()} ${riderModel!.distanceUnit.toString()}',
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(language.duration, style: primaryTextStyle()),
                              ),
                              /*Expanded(
                                child: Text('${riderModel!.perMinuteDriveCharge}', style:primaryTextStyle()),
                              ),*/
                              Text('${riderModel!.perMinuteDriveCharge}', style: primaryTextStyle()),
                            ],
                          ),
                           /* totalCount(
                                ...
                                description: '',
                                subTitle:
                                    '${riderModel!.perMinuteDriveCharge}'),*/
                            SizedBox(height: 8),
                            totalCount(
                            ...
                            if (paymentData != null)
                              totalCount(
                                  title: language.tip,
                                  description: '',
                                  subTitle: paymentData!.driverTips.toString()),
                      ...
                      if (currentData!.payment == null)
                        AppButtonWidget(
                          ...
                          onTap: () {
                            ...
                            launchScreen(context, ReviewAtEndScreen(),
                                isNewTask: true,
                                pageRouteAnimation:
                                    PageRouteAnimation.SlideBottomTop);
                            // launchScreen(context, RiderDashBoardScreen(),
